...
public class GitRepository : IGitRepository
{
    ...
    public async Task<IEnumerable<RepoDetails>> Get(ApiRequest apiRequest)
    {
        ...
        var repositories = await JsonSerializer.DeserializeAsync<List<RepoDetails>>(await streamTask);
